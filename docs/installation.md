...
executable:
    ...
    curl -Lo ~/.local/bin/rcl https://github.com/ruuda/rcl/releases/download/v0.14.0/rcl-0.14.0-x86_64-unknown-linux-gnu
...
[flake-enabled][flakes] version of [Nix][nix], such as Nix 2.18:
    ...
    nix run 'github:ruuda/rcl?ref=v0.14.0' -- --help
...
The Nix flake also includes the Python module:
    ...
    PYTHONPATH=$(nix build github:ruuda/rcl?ref=v0.14.0#pyrcl --print-out-paths)/lib python3
