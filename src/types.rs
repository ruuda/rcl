...
pub struct Requirement {
    /// When set, append a note to the type error.
    note: Option<(Span, &'static str)>,
    /// When set, append a help message to the type error.
    help: Option<&'static str>,
    /// When set, replace the default type expectation message with this one.
...
#[derive(Clone, Debug, Eq, Ord, PartialEq, PartialOrd)]
pub enum TypeReq {
    /// The type is unconstrained. The requirement never fails to be satisfied.
    None,
